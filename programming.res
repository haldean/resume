...
- *GPA:* 4.23, *IB Score:* 41, *SAT:* 2270
- *Honors:* Principal's Honor Roll;
 Math, Physics and Theater Graduation Awards;
...
- Wrote software for aggregating large datasets using a
  data processing pipeline within a MapReduce framework
- Wrote integration tests for a large system, testing 
  interactions between back ends, front ends, a job server
  and an API service
- Used Google technologies including Bigtable, FlumeJava,
  the Google Web Toolkit and the Guice dependency injection
  framework
...
- Special effects makeup for _Next Door_, stage crew for
  _The Boychick Affair_, and sound design for _Press Seven_,
...
-- Application Developer Initiative --
New York, NY
Lecture: Introduction to Web Applications in Django
December 1, 2010
...
- Managed a team of five engineering students working to design and
  build a green roof for the Old Broadway Synagogue in upper Manhattan
...
| Photoshop, OpenSCAD, Illustrator, VectorWorks, Eclipse, Microsoft
| Office Suite, iWork, iLife, QEMU, Mac OSX, Ubuntu, Arch Linux
|
| Interests
